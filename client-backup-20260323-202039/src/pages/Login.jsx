...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (!normalizedUsername || !normalizedPassword) {
      const emptyCredentialMessage = 'Please enter your username and password.';
      setError(emptyCredentialMessage);
      showToast({ message: emptyCredentialMessage, type: 'error' });
      return;
    }
    ...
    try {
      const loggedInUser = await login({ username: normalizedUsername, password: normalizedPassword });
